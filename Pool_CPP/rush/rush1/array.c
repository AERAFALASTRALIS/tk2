...
static void     ArrayIterator_decr(ArrayIteratorClass *this)
{
    this->_idx -= 1;
}
...
static const ArrayIteratorClass   ArrayIteratorDescr = {
    {   /* Iterator struct */
        ...
        .__decr__ = (decr_t)&ArrayIterator_decr,
...
static void     Array_ctor(ArrayClass *this, va_list *args)
{
    ...
    this->_tab = malloc(sizeof(Class *) * this->_size);
    if (this->_tab == NULL)
        raise("Out of memory");
...
static Object *Array_front(ArrayClass *this)
{
    return (NULL);
}

static Object *Array_back(ArrayClass *this)
{
    return (NULL);
}

static Object **Array_data(ArrayClass *this)
{
    return (this->_tab);
}
...
static const ArrayClass   _descr = {
    {   /* Container struct */
        ...
        .__front__ = (direct_t)&Array_front,
        .__back__ = (direct_t)&Array_back,
        .__data__ = (data_t)&Array_data,
    },
    ._type = NULL,
    ._size = 0,
    ._tab = NULL
